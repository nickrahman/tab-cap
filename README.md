...
When you try to open tab 6, Tab Cap closes the new tab, briefly shows a small browser popup in the center of the screen, and plays a short beep. Pinned tabs do not count toward the limit.
